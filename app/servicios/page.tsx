...
export const metadata: Metadata = { title: 'Servicios | ASSEL SpA', description: 'Asesoría en gestión preventiva, documentación, capacitación, auditorías y seguridad de proyectos.' };
